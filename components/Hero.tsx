  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="animate-pulse-slow absolute bottom-1/4 right-1/4 size-96 rounded-full bg-purple-500/10 blur-3xl"
      ...
      <div className="container relative z-10 mx-auto px-6 py-2">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            <Button
              size="lg"
              className="neon-glow transition-all bg-gradient-to-r rounded-full px-2 from-green-600 to-cyan-600 text-lg font-semibold text-white  duration-300 hover:scale-105 hover:from-green-500 hover:to-cyan-500"
              onClick={() => router.push("/game")}
            >
              <span className="pl-6 pr-2 tracking-wider">Join Game</span>
            ...
            <Button
              variant="outline"
              size="lg"
              className="glass border-2 border-white/20 px-8 py-4 rounded-full text-lg font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-white/10"
      ...
      <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-green-900/40 to-transparent"></div>
    </div>
  )
}
