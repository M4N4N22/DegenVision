        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="glass mb-8 inline-flex items-center gap-2 rounded-full px-4 py-2">
            <span className="text-sm font-medium text-white/50">
              Powered by <span className="text-white">NODIT</span>
            </span>
          </div>

          {/* Main headline */}
          <h1 className="in mb-6 text-6xl font-extrabold md:text-7xl tracking-tighter uppercase">
            <span className="text-emerald-500">Predict the Chain.</span>
            <br />
            <span className="text-white">Prove Your Vision.</span>
          </h1>

          {/* Subtitle */}
          <p className="mx-auto mb-12 max-w-3xl text-xl leading-relaxed text-white/50 md:text-2xl">
            Leverage real-time on-chain wallet activity and AI-powered insights
            to make strategic predictions. Test your foresight against the
            market and climb the leaderboard.
          </p>
